...
cpuy4 = []
cpucount = 0
file = open(r'H:\rdma_shuffle\data\cpu.txt', 'r')
for line in file:
    parts = line.split("\t")
...
memy6 = []
memcount = 0
file = open(r'H:\rdma_shuffle\data\mem.txt', 'r')
for line in file:
    parts = line.split("\t")
...
ioy2 = []
iocount = 0
file = open(r'H:\rdma_shuffle\data\io.txt', 'r')
for line in file:
    parts = line.split("\t")
    iox.append(iocount)
...
pltmem.fill_between(memx, [0] * len(cpux), memy1, facecolor='#353587')
