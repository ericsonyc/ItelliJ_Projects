...
public interface PlayerInterface {
    ...
    public static final int COM_PLAYER = 0;
...
//    public static final int ALL_PATH = 4;
    ...
    public static final String R_DEFAULT_ARGS = "1000 fills";
    public static final String CLICK_DEFAULT_ARGS = "n/a";
//    public static final String ADJ_DEFAULT_ARGS = "n/a";

    public static final String[] playerList = {"Computer Player", "Human Player"};

    public static final int[] playerIndex = {COM_PLAYER, CLICK_PLAYER};

    public static final String[] argsList = {R_DEFAULT_ARGS, CLICK_DEFAULT_ARGS};

//    public static final String[] playerList = {"Random Fill Path", "Random Fill Spot", "Seasonal Adjacency Player", "Human Player","Classic Adjacency Player"};
