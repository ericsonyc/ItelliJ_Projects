...
public class OutputShotNoThread {
    ...
    public void run() {
        try {
            // this.register(this);
            getOuputShot();
            System.out.println("outputshot key:" + keys[0] + ",value:" + fcxy[0] + "," + fcxy[1]);
...
//                    }
                    //System.out.println("length:" + length);
                    MyThread th = new MyThread(ap, j * previous, length, fs, trace, i, sx, sy, gx, gy);
                    threads[j] = th;
                    th.start();
                    previous = length;
                }
    ...
    class MyThread extends Thread {
        ...
        private void computeKernel() {
            ...
            int count = index;
            for (int t = index; t < length + index; t++) {
...
//                if (ap[t] - ap[count] < 0) {
//                    System.out.println("ap:" + ap[t] + ",t:" + t + ",count:" + count);
//                }
...
//                }
        ...
        private void readData(String path, int length, int start, int SIZE,
            ...
            try {
                ...
                byte[] datafully = new byte[datas.length * SIZE];
