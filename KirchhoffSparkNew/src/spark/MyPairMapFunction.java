...
public class MyPairMapFunction implements
    ...
    public Iterable<Tuple2<Integer, String>> call(Tuple2<Integer, String> tuples)
        ...
        //System.out.println("mapStartTime:" + System.currentTimeMillis() + "ms");
        ...
        try {
            ...
            HashMap<Integer, float[]> maps = new HashMap<Integer, float[]>();
//            OutputShot output = new OutputShot(keys, fcxydatas, pconf, maps);
//            output.run();

            //ComputeKernelNoThread compute=new ComputeKernelNoThread(keys,fcxydatas,pconf,maps);
            //compute.run();
