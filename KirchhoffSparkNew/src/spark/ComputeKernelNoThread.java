...
public class ComputeKernelNoThread {
    ...
    public ComputeKernelNoThread(int[] keys, float[] fcxy, ProgramConf pconf,
        ...
        private void computeKernel() {
            ...
            for (int t = 0; t < length; t++) {
                ...
                if (ap[t] - ap[count] >= CONSTANT) {
                    ...
                    velocity = new float[ont * LENGTH];
                    readData(PATH + "/rmsv.data", ont, ap[t], Float.SIZE / 8, velocity, fs);
                    count += t;
                    //System.out.println("LENGTH:" + LENGTH);
                }
                if (t % 1000 == 0)
